    ...
    <footer className="bg-secondary text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Industrin.se</h3>
            <p className="text-gray-300 mb-4">
              Sveriges ledande plattform för att hitta och kontakta industriföretag.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Kategorier</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Regioner</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Företagsprofiler</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold mb-4">För företag</h4>
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Hjälp</a></li>
        ...
        <div className="border-t border-gray-600 pt-8 mt-8 text-center text-gray-300">
          <p>&copy; 2024 Industrin.se. Alla rättigheter förbehållna.</p>
