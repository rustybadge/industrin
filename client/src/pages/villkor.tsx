  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 className="text-5xl font-bold mb-8 text-[#171717]">Användarvillkor</h1>
        ...
        <div className="text-gray-700 space-y-8">
          ...
          <section>
            <h2 className="text-3xl font-bold text-[#1f2937] mb-4">Personuppgifter</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-3xl font-bold text-[#1f2937] mb-4">Kontakt</h2>
            <p className="leading-relaxed">
