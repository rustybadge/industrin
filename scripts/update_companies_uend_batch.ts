...
async function updateUENDCompanies() {
  try {
    console.log('Processing U-END companies batch...\n');

    // Read and parse CSV file
    const csvContent = readFileSync('attached_assets/U-END-Companies_REPLITSMALL_1753984143604.csv', 'utf-8');
    ...
    console.log('\n=== U-END Companies Update Summary ===');
    ...
    console.error('Error updating U-END companies:', error);
  } finally {
    await pool.end();
  }
}
