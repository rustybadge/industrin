...
async function updatePQRCompanies() {
  try {
    console.log('Processing PQR-companies batch...\n');

    // Read and parse CSV file
    const csvContent = readFileSync('attached_assets/PQR-Companies_MINI_REPLIT_1753980370380.csv', 'utf-8');
    ...
    console.error('Error updating PQR-companies:', error);
  } finally {
    await pool.end();
  }
}
