...
async function updateSTCompanies() {
  try {
    console.log('Processing ST-companies batch...\n');

    // Read and parse CSV file
    const csvContent = readFileSync('attached_assets/ST-Companies_MINI_REPLIT_1753981329408.csv', 'utf-8');
    ...
    console.error('Error updating ST-companies:', error);
  } finally {
    await pool.end();
  }
}
