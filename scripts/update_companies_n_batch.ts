...
async function updateNCompanies() {
  try {
    console.log('Processing N-companies batch...\n');

    // Read and parse CSV file
    const csvContent = readFileSync('attached_assets/Sheet 2-Table 1_1753979584105.csv', 'utf-8');
    ...
    console.error('Error updating N-companies:', error);
  } finally {
    await pool.end();
  }
}
